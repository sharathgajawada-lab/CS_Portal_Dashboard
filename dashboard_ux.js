...
def page_expand_smoke(page, fname: str, label: str, setup=None):
    ...
    visible_expand = page.locator('.chart-expand-btn').count()
...
def main() -> int:
    with sync_playwright() as p:
        ...
        forbidden = ["Data quality:", "Executive readout", "Primary risk", "Protected drilldowns", "Admin access", "Unlock raw drilldowns"]
